...
class OrderingBoardRect
{
   public:
    ...
    LocalCoordinateGrid get_point_coordinate_grid(const int row, const int col,
                                                  const std::vector<MarkerRing> &rings) const;

    float average_trust_radius(const int row, const int col, const std::vector<MarkerRing> &rings) const;
...
std::array<LocalCoordinateGrid, 4> estimate_local_coordinate_grid(const OrderingBoardRect &ordering_set,
                                                                  ...
                                                                  const std::vector<MarkerRing> &rings_expanded);
/**
 ...
 */
std::vector<int> create_markers_order(const std::vector<MarkerNeighborhood> &graph,
